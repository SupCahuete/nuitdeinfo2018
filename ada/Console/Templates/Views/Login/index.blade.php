    ...
    <div class="row">
      <div id="loginCard" class="col s10 m8 l8 offset-s10 offset-m2 offset-l2 white z-depth-2">
        <div class="container">
          ...
          <div class="row">
            <form class="col s12" role="form" method="POST" action="@route('TAG_GUARD_NAME.login.store')">
              {{ csrf_field() }}
              ...
              <div class="row">
                <div class="col s12 center-align">
                  <a class="grey-text" href="@route('TAG_GUARD_NAME.forgotPassword.index')">Mot de passe oublié ?</a>
                </div>
                <div class="col s12 center-align">
                  <a class="grey-text" href="@route('TAG_GUARD_NAME.register.index')">Pas encore de compte? Rejoignez @config('app.name')</a>
                </div>
              </div>
            </form>
          </div>
